...
7. Every chart uses `BRAND_COLORS` or `BRAND_SEQUENCE` — no default Plotly rainbow, Matplotlib `tab10`, or `Set2` cycles are visible. Bar charts, histograms, scatter plots, and pie/donut charts must all use the brand palette.
